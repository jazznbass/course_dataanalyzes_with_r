...
- [<div class="red2">]**Factors**: Categorical values with assigned labels]{.em}
- **List**: A series of elements, each containing an object
- [<div class="red2">]**Data Frames**: A list with one vector for each element and all vectors of the same length]{.em}
- **Matrix**: A two dimensional table with values of the same data type.
- **Array**: Like a matrix but with more dimensions.
