...
1. Create a numeric vector `x` with the values 10, 20, 30, 40, and 50 and a named version `x_named` with names a, b, c, d, and e.
2. Select the 2nd and 4th elements using **numeric** indexing.
3. **Reorder** the vector x with `c(5,1,5,3)`.
