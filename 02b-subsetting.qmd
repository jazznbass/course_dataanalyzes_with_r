...
With negative numbers, elements are dropped:
...
## Task - solution {.smaller background-image="images/bg-task.png"}
...
Square brackets select a column of a data frame either by a number or the column name:
...
It takes a *logical vector* as an *argument* and returns a *numerical vector*.
