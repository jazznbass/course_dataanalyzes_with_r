...
- E.g.: You want to explain the *life expectancy* by certain aspects of behavior (diet, physical activity), environmental aspects (polution, health care).
...
x <- c(1,3,1,5,6,5,7,8,9,8,10,9)
y <- c(2,1,4,5,5,6,5,7,8,8,9,10)
plot(x, y, type = "p", xlab = "Predictor X", ylab = "Criteria Y", 
     xlim = c(0,10), ylim = c(0,10), xaxs="i",yaxs="i", col = "blue", lwd = 2)
```
