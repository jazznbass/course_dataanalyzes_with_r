...
![](images/clipboard-317119753.png)
:::
...
-   Also, at the top of the source file you should find ![](images/clipboard-1819079286.png){width="70" height="24"}
...
-   An empty chunk can be inserted directly through the ![](images/clipboard-1193950122.png){width="27"} button .
...
-   Quarto documents start with a header that contains important document options. YAML you can set several document parameters.
-   This header is put between leading and ending "---".
-   Information here are provided in a format called YAML (YAML is not a markup language)
